...
data class ApplicationPreferences(
    ...
    companion object {
        ...
        const val DEFAULT_STREAMING_BACK_BUFFER_MS = 60_000
        ...
        val IMAGE_BROWSER_THUMBNAIL_SIZE_OPTIONS = listOf(512, 1024, IMAGE_BROWSER_THUMBNAIL_SIZE_ORIGINAL)
        ...
        fun normalizeImageBrowserThumbnailSizePx(sizePx: Int): Int = sizePx.takeIf { it in IMAGE_BROWSER_THUMBNAIL_SIZE_OPTIONS }
            ?: DEFAULT_IMAGE_BROWSER_THUMBNAIL_SIZE_PX
    }
}
